...
type
  ...
  public
    ...
    class procedure Open(FrmClass: TFormClass; Frm: TForm;
      Parent: TPanel = nil);
    class procedure OpenModal(FrmClass: TFormClass; Frm: TForm;
      Parent: TForm = nil);
...
class procedure TNavigation.OpenModal(FrmClass: TFormClass; Frm: TForm;
  Parent: TForm = nil);
begin
  // Fundo opaco...
